...
pub struct GetEthCollectionForecastsRequestArchParams {
...
impl GetEthCollectionForecastsRequestArchParams {
    /// JSON containing options for the ARCH family model.
    pub fn new() -> GetEthCollectionForecastsRequestArchParams {
