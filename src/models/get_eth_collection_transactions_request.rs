...
pub struct GetEthCollectionTransactionsRequest {
...
impl GetEthCollectionTransactionsRequest {
    pub fn new(collection_address: String) -> GetEthCollectionTransactionsRequest {
