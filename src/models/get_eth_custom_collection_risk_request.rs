...
pub struct GetEthCustomCollectionRiskRequest {
...
impl GetEthCustomCollectionRiskRequest {
    pub fn new(collection_address: String, holding_period: String) -> GetEthCustomCollectionRiskRequest {
