...
pub struct GetEthCustomTokenRiskRequest {
...
impl GetEthCustomTokenRiskRequest {
    pub fn new(collection_address: String, token_id: Vec<String>, holding_period: String) -> GetEthCustomTokenRiskRequest {
