...
pub struct GetEthDefaultTokenRiskRequest {
...
impl GetEthDefaultTokenRiskRequest {
    pub fn new(collection_address: String, token_id: Vec<String>, holding_period: String) -> GetEthDefaultTokenRiskRequest {
