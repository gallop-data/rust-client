...
pub struct GetEthTokenForecastsRequest {
...
impl GetEthTokenForecastsRequest {
    pub fn new(collection_address: String, token_id: Vec<String>) -> GetEthTokenForecastsRequest {
