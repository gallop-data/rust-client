...
pub struct GetPolCollectionTransactionsRequest {
...
impl GetPolCollectionTransactionsRequest {
    pub fn new(collection_address: String) -> GetPolCollectionTransactionsRequest {
