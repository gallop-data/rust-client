...
pub struct GetPolCustomCollectionRiskRequest {
...
impl GetPolCustomCollectionRiskRequest {
    pub fn new(collection_address: String, holding_period: String) -> GetPolCustomCollectionRiskRequest {
