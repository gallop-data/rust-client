...
pub struct GetPolDefaultCollectionRiskRequest {
...
impl GetPolDefaultCollectionRiskRequest {
    pub fn new(collection_address: String, holding_period: String) -> GetPolDefaultCollectionRiskRequest {
