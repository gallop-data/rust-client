...
pub struct GetPolTokenAppraisalRequest {
...
impl GetPolTokenAppraisalRequest {
    pub fn new(collection_address: String, token_id: Vec<String>) -> GetPolTokenAppraisalRequest {
