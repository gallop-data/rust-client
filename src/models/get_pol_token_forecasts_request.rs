...
pub struct GetPolTokenForecastsRequest {
...
impl GetPolTokenForecastsRequest {
    pub fn new(collection_address: String, token_id: Vec<String>) -> GetPolTokenForecastsRequest {
