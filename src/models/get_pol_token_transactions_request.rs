...
pub struct GetPolTokenTransactionsRequest {
...
impl GetPolTokenTransactionsRequest {
    pub fn new(collection_address: String, token_id: String) -> GetPolTokenTransactionsRequest {
