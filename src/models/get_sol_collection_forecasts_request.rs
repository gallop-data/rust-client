...
pub struct GetSolCollectionForecastsRequest {
    ...
    pub arch_params: Option<Box<crate::models::GetSolCollectionForecastsRequestArchParams>>,
}

impl GetSolCollectionForecastsRequest {
    pub fn new(collection_tag: String) -> GetSolCollectionForecastsRequest {
