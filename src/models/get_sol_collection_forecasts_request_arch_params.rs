...
pub struct GetSolCollectionForecastsRequestArchParams {
...
impl GetSolCollectionForecastsRequestArchParams {
    /// JSON containing options for the ARCH family model
    pub fn new() -> GetSolCollectionForecastsRequestArchParams {
