...
pub struct GetSolCollectionTransactionsRequest {
...
impl GetSolCollectionTransactionsRequest {
    pub fn new(collection_tag: String) -> GetSolCollectionTransactionsRequest {
