...
pub struct GetSolCustomTokenRiskRequest {
...
impl GetSolCustomTokenRiskRequest {
    pub fn new(mint_address: Vec<String>, holding_period: String) -> GetSolCustomTokenRiskRequest {
