...
pub struct GetSolDefaultTokenRiskRequest {
...
impl GetSolDefaultTokenRiskRequest {
    pub fn new(mint_address: Vec<String>, holding_period: String) -> GetSolDefaultTokenRiskRequest {
