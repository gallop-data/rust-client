...
pub struct GetSolTokenForecastsRequest {
    ...
    pub arch_params: Option<Box<crate::models::GetSolTokenForecastsRequestArchParams>>,
}

impl GetSolTokenForecastsRequest {
    pub fn new(mint_address: Vec<String>) -> GetSolTokenForecastsRequest {
